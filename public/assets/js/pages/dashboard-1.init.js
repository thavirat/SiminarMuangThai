...
var chart = new ApexCharts(document.querySelector("#apex-area-charts"), options);
chart.render();
...
var options8 = {
  ...
  var chart8 = new ApexCharts(document.querySelector("#radialBar"), options8);
  chart8.render();
